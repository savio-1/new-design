...
(function (global) {
  ...
  const FONTS = [
    ...
    { family: 'Very Vogue Display', weights: [400], italic: true, category: 'Serif', local: true },
    { family: 'Very Vogue Text', weights: [400], italic: true, category: 'Serif', local: true },
    { family: 'EB Garamond', weights: [400, 500, 600, 700, 800], italic: true, category: 'Serif', local: true },
