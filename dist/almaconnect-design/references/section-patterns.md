...
> **Container note.** This catalog was measured on a 1344px/48px container. The
> system has since moved to **1288px with 76px margins** (SKILL.md §3). Inherit each
> pattern's *proportions and hierarchy*, not its literal pixel widths. Type values
> here also predate the Geist ladder — SKILL.md §2 wins on any type question.
