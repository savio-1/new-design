...
# The panel's source of truth is the page that ships in the product, one
# directory over; the docs build off that copy so there is only ever one.
SRC = (HERE.parent / 'cogentiq' / 'model-hub.html').read_text()
